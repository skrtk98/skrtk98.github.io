...
他方、ある条件 $P$ を満たすような $x$ の全体を $\left\{x\mathrel{}\middle|\mathrel{}P(x)\right\}$ と表し、この表現を **内包的記法** という。
特に考える $x$ をある集合 $A$ の要素に限定する場合、その全体を $\left\{x\in A\mathrel{}\middle|\mathrel{}P(x)\right\}$ と表す。
